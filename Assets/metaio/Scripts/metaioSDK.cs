...
#region Editor script fields
	...
	public static String[] trackingAssets = {"None", "DUMMY", "GPS", "ORIENTATION", "LLA", "CODE", "QRCODE", "StreamingAssets...", "Absolute Path or String...", "Generated"};
	...
	void Start () 
	{
		...
		// Start the camera
		MetaioSDKUnity.startCamera(cameraIndex, (uint)cameraWidth, (uint)cameraHeight, (uint)cameraDownsample);
