...
#region DLL functions
	...
	///  Start device camera
	/// </summary>
	public static UInt64 startCameraInternal(byte[] buf)
	{
		...
		object[] args = {jo, buf};
		long ret = cls.CallStatic<long>("StartCamera", args);
		checked
		{
			return (UInt64)ret;
		}
...
#elif UNITY_ANDROID
					ret = parseUInt64ToVector2diUnsigned(startCameraInternal(buf));
#else
